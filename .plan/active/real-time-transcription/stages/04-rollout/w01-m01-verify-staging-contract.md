...
- **ID:** S04-W01-M01
- **Why manual:** CI fakes cannot prove EU routing, real provider behavior, ingress lifetime, physical recorder output, visual preview latency, or content-free operational logs.
...
1. Deploy merged auth with `ASYNC_TRANSCRIPTION_PROVIDER=openai` and realtime disabled.
